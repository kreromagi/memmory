  ...
  return (
    <div className="app">
      <header className="header">
        ...
        <p>Извлечение и анализ дизайн-систем из Figma</p>
      </header>
        ...
        {showSettings && (
          <section className="settings-section">
            <div className="settings-header">
              <h2>⚙️ Настройки</h2>
              <button className="toggle-btn" onClick={() => setShowSettings(false)}>
                Свернуть
              </button>
            </div>
            ...
            <div className="settings-group">
              ...
              <div className="input-group">
                ...
                />
                <small>Получите ключ в: Figma → Settings → Personal Access Tokens</small>
              </div>
              ...
              <div className="input-group">
                ...
                <input
                  ...
                  disabled={isExtracting}
                />
                <small>Найдите в URL: figma.com/file/[ID_ФАЙЛА]/...</small>
              </div>
            </div>

            <div className="settings-group">
              <h3>Supabase (опционально)</h3>
              <div className="input-group">
